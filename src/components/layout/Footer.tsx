        ...
        <div className="grid grid-cols-1 min-[901px]:grid-cols-4 gap-12 py-16 border-b border-white/10">
          <div className="min-[901px]:col-span-1">
            <Link href="/" className="flex items-center gap-2 no-underline mb-6">
              <svg className="text-amber-500" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="font-serif font-bold text-2xl text-white">Safha</span>
              <span className="font-serif italic font-normal text-2xl text-amber-500">Labs</span>
            </Link>

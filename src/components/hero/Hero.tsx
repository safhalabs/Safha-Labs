  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 min-[901px]:grid-cols-[1.1fr_1fr] gap-16 items-center w-full">
        <div
          className={`relative transition-all duration-800 ease-out max-[900px]:text-center ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[20px]'
            }`}
        >
          ...
          <h1 className="text-[3.5rem] max-[1024px]:text-[3rem] max-[640px]:text-[2.25rem] leading-[1.1] font-extrabold text-gray-900 mb-6 tracking-[-0.02em]">
            Mitra Teknologi Anda untuk Digitalisasi yang{" "}
            <span className="font-serif italic text-amber-600 font-semibold">Relevan dan Praktis</span>
          </h1>
        ...
        <div
          className={`relative w-full h-full min-h-[400px] max-[900px]:min-h-[350px] max-[900px]:max-w-[500px] max-[900px]:mx-auto max-[640px]:min-h-[280px] transition-all duration-1000 delay-200 ease-out ${isVisible ? 'opacity-100 scale-100 translate-x-0' : 'opacity-0 scale-95 translate-x-5'
            }`}
        >
          <HeroDashboardCard />
